                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="viewreviews?reviewId=${r[0]}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deletereviews?reviewId=${r[0]}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editreviews?reviewId=${r[0]}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
