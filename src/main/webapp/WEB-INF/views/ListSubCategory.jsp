                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="viewsubcategory?subCategoryId=${s[0]}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deletesubcategory?subCategoryId=${s[0]}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editsubcategory?subCategoryId=${s[0]}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
