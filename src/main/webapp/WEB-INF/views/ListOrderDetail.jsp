                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="vieworderdetail?orderDetailId=${o[0]}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deleteorderdetail?orderDetailId=${o[0]}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editorderdetail?orderDetailId=${o[0]}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
