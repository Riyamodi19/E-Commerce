                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="viewcity?cityId=${c[0]}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deletecity?cityId=${c[0]}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editcity?cityId=${c[0]}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
