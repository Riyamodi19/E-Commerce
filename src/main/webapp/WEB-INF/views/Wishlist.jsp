...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="wishlist" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="${totalWishlist}">
	...
	<section class="bg0 p-t-23 p-b-130" >
		<div class="container">
			<div class="p-b-10" style="margin-top:150px;">
			...
			<div class="row isotope-grid">
				<c:forEach items="${wishlistProducts}" var="p">
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${p.category}">
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${p.productImageURL1}" alt="IMG-PRODUCT">
								<a href="productdetail?productId=${p.productId}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal" 
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								...
								<div class="block2-txt-child2 flex-r p-t-3">
									<a href="removefromwishlist/${p.productId}" class="btn-addwish-b2 js-addwish-b2 js-addedwish-b2 pos-relative">
										<img class="icon-heart2 dis-block trans-04" src="ashion/images/icons/icon-heart-02.png" alt="ICON">
									</a>
								</div>
							</div>
						</div>
			...
			<c:if test="${empty wishlistProducts}">
				<p class="text-center mtext-105 p-t-40">Your wishlist is empty.</p>
			</c:if>
		</div>
	</section>
...
<!--===============================================================================================-->
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
	...
	<script>
		$('.js-addwish-b2').on('click', function(e){
			e.preventDefault();
			var nameProduct = $(this).closest('.block2-txt').find('.js-name-b2').text();
