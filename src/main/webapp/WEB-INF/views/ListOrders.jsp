                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="vieworders?orderId=${o[0]}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deleteorders?orderId=${o[0]}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editorders?orderId=${o[0]}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
